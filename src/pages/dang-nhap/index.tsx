...
function LoginPage() {
  return (
    <div className="login__container w-full flex justify-center overflow-y-hidden">
      <div className="login__decoration order-1 basis-1/2 relative h-screen hidden lg:block">
      ...
      <div className="login__main order-2 basis-1/2 h-screen flex items-center justify-center">
        <div className="login__main--content w-80">
