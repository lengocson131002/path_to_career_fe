...
function LoginPage() {
    return ( <div className="login__container w-full flex">
            ...
            <div className="login__main--content w-2/3">
                ...
                <div className="login__main--form mt-3 max-w-[400px]">
                    <Form layout='vertical'>
                        <label htmlFor="user_email" className='font-medium mb-1 block'>Email hoặc số điện thoại</label>
                        <Form.Item name='userCre' noStyle>
                            <Input placeholder='Nhập email hoặc số điện thoại' style={{height: 40}} className='placeholder:font-medium border-p2c-gray'/>
                        </Form.Item>
                        <label htmlFor="user_email" className='font-medium mt-3 mb-1 block'>Mật khẩu</label>
                        <Form.Item name='userPwd' noStyle>
                            <Input.Password placeholder='Nhập mật khẩu' style={{height: 40}} className='placeholder:font-medium border-p2c-gray'/>
                        </Form.Item>
                        <div className="login__main--action">
                            <Form.Item noStyle>
                                <Button type='primary' className='bg-primary hover:!bg-primary hover:opacity-80 w-full h-[48px] mt-5 text-xl font-semibold'>Đăng nhập</Button>
                            </Form.Item>
                            ...
                            <Form.Item noStyle>
                                <Button type='default' className='group bg-white text-primary border-primary border-2 hover:!bg-primary hover:!text-white hover:!border-primary w-full h-[48px] text-xl font-semibold'>
                    ...
                    <div className="login__main--nav font-semibold mt-3">
                        Chưa có tài khoản? <Link to='/dang-ky' className="text-primary">Đăng ký</Link> ngay!
                    </div>
                </div>
            </div>
        </div>
